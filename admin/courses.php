<?php require("../process/process-course.php") ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<label>Enter your Name</label>
		...
		<input type="submit" name="submit" value="Send" id="send-notification-btn">
...
// document.getElementById('send-notification-btn').addEventListener('click', function(event) {
//   event.preventDefault();

//   var notificationMessage = 'New Course Added!';

//   // Get the current date and time in Indian Standard Time
//   var currentDate = new Date().toLocaleString("en-US", {timeZone: "Asia/Kolkata"});

//   // Convert the date and time to the desired format (DDMMYYYYHHMM)
//   var formattedDateTime = currentDate.toLocaleString().replace(/\D/g,'').substr(0, 12);

//   // Use the formatted date and time as the notification ID
//   var notificationId = formattedDateTime;

//   // Use the same ID for the collapse_id property to pile up notifications
...
var formattedDateTime = currentDate.replace(/\D/g, '');
